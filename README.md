...
| 02 | **Tasas de cambio** | Pizarra con USD/EUR BCV, paralelo y USDT estimado en vivo (dolarapi.com), variación vs. día anterior y conversor entre monedas |
...
- Componentes propios (sin librerías de UI)
